...
const Login = ({ open, setopen, openreg, setopenreg }) => {
      ...
      <div className="w-[90%] sm:w-[90%] md:w-[400px] lg:w-[500px] bg-white rounded-md p-3 ">
        ...
        <div className="">
          <div className="text-[18px] font-semibold text-black text-center    ">
            Welcome back to Oja MI
          </div>
          <div className="text-normal mt-3 text-center text-lightprimary">
            It is so nice to have you once again! Enjoy your shopping
            experience, cheers!
          </div>
          {/* form group */}
          <div className="w-[90%] mx-auto">
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="flex">
                ...
                <div className=" px-3 text-lightprimary">Remember me</div>
              </div>
              <div className="font-semibold text-black">Forgot password</div>
            </div>
